...
<html lang='en'>
    ...
    <body>	
		<div class="navbar">
			...
			<li class="active"><a href="tutorials.html"><i class="fa fa-pencil-square fa-fw"></i> Tutorials</a></li>
		...
		<div id="content">
			...
			<div id="basic-css-tutorial" class="tutorial">
			    <h4><a href="tutorials/basic-css.html">Basic CSS</a></h4>
			...
			<div id="text-tutorial" class="tutorial">
			    <h4><a href="tutorials/text.html">Text</a></h4>
			...
			<div id="borders-tutorial" class="tutorial">
			    <h4><a href="tutorials/borders.html">Borders & Backgrounds</a></h4>
			...
			<div id="animation-tutorial" class="tutorial">
			    <h4><a href="tutorials/animation.html">Animation</a></h4>
			...
			<div id="navigation-tutorial" class="tutorial">
			    <h4><a href="tutorials/navigation.html">Navigation</a></h4>
